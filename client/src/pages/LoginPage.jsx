      ...
      <div className="auth-split-left">
        <div className="auth-card">
          <div className="auth-card-inner">
            ...
            {/* Logo */}
            <div className="mb-7 animate-fade-up" style={{ animationDelay: '0.05s', animationFillMode: 'both' }}>
              <img src="/modelsuite-talents.png" alt="Logo" className="w-44 h-auto object-contain mx-auto block" />
            </div>

            {/* Header */}
            <div className="text-center mb-6 animate-fade-up" style={{ animationDelay: '0.1s', animationFillMode: 'both' }}>
              <h1 className="text-[24px] font-bold tracking-tight mb-1" style={{ color: '#F0F0F0' }}>Assessment Portal</h1>
              <p className="text-[13px]" style={{ color: '#6B7280' }}>Sign in to view assignments</p>
            </div>

            {/* Form */}
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 animate-fade-up" style={{ animationDelay: '0.15s', animationFillMode: 'both' }}>
              <div className="flex flex-col gap-1.5 group">
                <label className={labelCls} htmlFor="email" style={{ color: '#6B7280' }}>Email address</label>
              ...
              <div className="flex flex-col gap-1.5 group">
                <label className={labelCls} htmlFor="password" style={{ color: '#6B7280' }}>Password</label>
            ...
            <p className="mt-6 text-[13px] text-center animate-fade-up" style={{ color: '#6B7280', animationDelay: '0.2s', animationFillMode: 'both' }}>
              New candidate?{' '}
              <Link to="/register" className="font-medium hover:underline transition-all duration-200" style={{ color: '#3B82F6' }}>
                Setup your profile
              </Link>
            </p>
          </div>
      ...
      <div className="auth-split-right">
        ...
        <div className="relative z-10 max-w-[480px] w-full">
          <h2 className="text-[48px] font-extrabold leading-[1.1] tracking-tight mb-5 animate-fade-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            <span className="gradient-text">Intern Assessment</span><br/>
            <span style={{ color: '#F0F0F0' }}>Pipeline.</span>
          </h2>
          ...
          <div className="grid grid-cols-3 gap-4 animate-fade-up" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
            {[
              { num: 'PR', label: 'Submission Format', icon: '↗', color: '#3B82F6' },
              { num: 'Core', label: 'Team Review', icon: '✦', color: '#8B5CF6' },
              { num: '100%', label: 'Skill Focus', icon: '⚡', color: '#EC4899' },
